...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN characters ON characters.series_id = series.id GROUP BY series.title WHERE species = human ORDER BY COUNT(species) DESC LIMIT 1;"
end
